...
import { Radio, RadioGroup, FormControl, FormControlLabel, FormLabel, colors } from '@mui/material'
...
export default function Product() {
  ...
  },[param.levelThree, sizeValue, colorValue, priceValue, pageNumber, discount, stock, sortValue, dispatch])
    ...
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
          ...
          <div className ="px-4 py-5 flex justify-centre">
